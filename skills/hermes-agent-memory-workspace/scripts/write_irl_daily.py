...
source: telegram-calendar
{people_block}
---

# IRL - {wikilink_date(args.date)}
...
"""
    ...
    state.setdefault("irlWrites", []).append({"at": now_iso(), "date": args.date, "path": str(out), "people": people})
